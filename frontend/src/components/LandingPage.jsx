        ...
        <div className="lp-w">
          ...
          <div className="lp-mods">
            {[
              ...
              { icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', title: 'Varyantlar', desc: 'Tüm araç varyantlarını görüntüleyin ve VECTO sonuçlarını analiz edin', c: 'var(--c-blue)', to: 'variants' },
              { icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', title: 'VECTO Çıktıları', desc: 'XML veri dosyalarını işleyin ve PDF raporları oluşturun', c: 'var(--c-amber)', to: 'variant-outputs' },
        ...
        <div className="lp-w">
          <div className="lp-ft-row">
            ...
            <nav className="lp-ft-links">
              {[['co2','CO₂ Emisyonlar'],['variants','Varyantlar'],['bom','BOM & Entegrasyon'],['dashboard','Dashboard']].map(([k,l]) => (
